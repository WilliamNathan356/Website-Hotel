        ...
        '<div class="room-item shadow rounded overflow-hidden">', 
            ...
            '<div class="p-4 mt-2">',
                ...
                '<div class="d-flex justify-content-between">',
                    `<a class="btn btn-sm btn-primary rounded py-2 px-4" href="${roomLocation}.html">View Detail</a>`,
                    `<a class="btn btn-sm btn-dark rounded py-2 px-4" href="${roomLocation}.html">Book Now</a>`,
                '</div>',
           '</div>',
       '</div>'
    ].join('');
